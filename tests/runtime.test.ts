    ...
    journeys: [
      {
        ...
        steps: [
          ...
          { action: "fill", selector: "#project-file", value: "invalid.json" },
          { action: "expectText", selector: "#state", value: "Selected invalid.json" },
          { action: "setStorage", state: "unavailable" },
          { action: "click", selector: "#save-storage" },
          { action: "expectText", selector: "#state", value: "Local storage unavailable" },
          { action: "setStorage", state: "available" },
          { action: "click", selector: "#save-storage" },
          { action: "expectText", selector: "#state", value: "Local draft saved" },
