...
export async function expectedProvenancePaths() {
  return [...new Set([
    ...
    "governance/knowledge-admission.json",
    "governance/knowledge-admission.schema.json",
    "governance/PRIVATE-RESEARCH-POLICY.md",
    ...
    "governance/public-knowledge-inventory.json",
    "governance/public-knowledge-inventory.schema.json",
    "governance/rule-registry.json",
    "governance/rule-registry.schema.json",
    "model/compiled-authority.json",
    "model/compiled-authority.schema.json",
    "model/ztothez-design-engineering-model.json",
    "model/ztothez-design-engineering-model.schema.json",
