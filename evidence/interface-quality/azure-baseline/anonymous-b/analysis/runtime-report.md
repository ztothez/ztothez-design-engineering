...
- Result: FAIL
- Findings: 3 errors, 2 warnings, 0 info
- Screenshots: 2
- Journeys: 1/1 passed
- Expected network policies: 0/0 satisfied
- Evidence directory: `/home/ztothez/Studio/experiments/UIX-Design-Skill/evidence/interface-quality/azure-baseline/anonymous-b/analysis`
                          ...
                          <div className="grid gap-4..." data-tsd-source="/src/compo...">
                            <div className="flex h-[36..." data-tsd-source="/src/compo...">
                              ...
                              <div className="flex-1 spa..." data-tsd-source="/src/compo...">
                                ...
                                >
+                                 14:56:23Z [SYSTEM] Console ready. Demo dataset loaded.
-                                 14:56:21Z [SYSTEM] Console ready. Demo dataset loaded.
                            ...
                      ...
                    ...
      ...
...
### ERROR ZTDE-RUNTIME-002 (journey:run-lovable-analysis)
                            ...
                            <div className="flex h-[36..." data-tsd-source="/src/compo...">
                              ...
                              <div className="flex-1 spa..." data-tsd-source="/src/compo...">
                                <div
                                  ...
                                  data-tsd-source="/src/components/optimizer/AuditConsole.tsx:96:15"
                                >
+                                 14:56:25Z [SYSTEM] Console ready. Demo dataset loaded.
-                                 14:56:24Z [SYSTEM] Console ready. Demo dataset loaded.
                            ...
                      ...
                    ...
      ...
...
### WARNING ZTDE-RUNTIME-012 (custom-1440x1000, journey:run-lovable-analysis)
...
### ERROR ZTDE-RUNTIME-016 (custom-1440x1000, journey:run-lovable-analysis)

Transform or positional animation remains active with reduced motion enabled.

Selector: `span.rounded-full`

- Animation duration is 2000ms and properties include offset.
